...
export interface ApiBasinBasin extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Slug: Attribute.UID<'api::basin.basin', 'Baslik'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiGeneralSiteSettingGeneralSiteSetting
  ...
  attributes: {
    ...
    Navbar: Attribute.Enumeration<['Navbar-1', 'Navbar-2']>;
    Iletisim: Attribute.Component<'ayarlar.iletisim-bilgileri', true>;
    KategoriYanBar: Attribute.Boolean & Attribute.DefaultTo<true>;
    UrunListesiYatay: Attribute.Boolean & Attribute.DefaultTo<true>;
    BeyazLogo: Attribute.Media;
    BlogKategoriYanBar: Attribute.Boolean & Attribute.DefaultTo<true>;
    DilSecenegiGorunumu: Attribute.Enumeration<['Yan Yana', 'Se\u00E7enek']> &
      Attribute.DefaultTo<'Se\u00E7enek'>;
    Depertmanlar: Attribute.Component<'ayarlar.depertmanlar', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
  ...
  attributes: {
    ...
    Blocks: Attribute.DynamicZone<
      [
        'blocks.hero',
        'blocks.slider',
        'blocks.text-with-overlay-image',
        'blocks.new-products',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ButonBaslik: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ButonUrl: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
